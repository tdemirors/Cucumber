...
public class Parent {
    ...
    public void waitUntilVisible(WebElement element){ // beklemeyi yap

        WebDriverWait wait = new WebDriverWait(GWD.getDriver(), Duration.ofSeconds(30));
        wait.until(ExpectedConditions.visibilityOf(element));
    }
    public void scrollToElement(WebElement element){ // kaydırmayı yap
    ...
    public void doubleClickFunction(WebElement element){
