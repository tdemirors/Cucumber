...
public class ExcelUtility {
   ...
   public static void writeExcel(String path, Scenario scenario, String browserName, String time){
       ...
       if (!f.exists()) {   // ! file YOKSA
           ...
           Row newRow = sheet.createRow(rowCount);  // en son satırın alltına yeni stır açıldı
     ...
     // TODO: kendisin evrilen path, scenario, browsertipi, zaman parametleri ile
     //  yeni bir excele bütün raporu yazacak. dosyanın var yada yok olduğunu kontrol etmeyi google dan bul
